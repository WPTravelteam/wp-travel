	...
	public static function register_trip() {
		...
		$args = array(
			...
			'rewrite'            => array(
				...
				// 'slug'       => $permalink['wp_travel_trip_type_base'] . '/%itinerary_types%',
				// 'slug'       => '%itinerary_types%',
				'with_front' => true,
			),
			'capability_type'    => 'post',
			'has_archive'        => true,
			// 'has_archive'        => $permalink['wp_travel_trip_base'],
			// 'has_archive'        => $permalink['wp_travel_trip_type_base'],
			'hierarchical'       => false,
			'menu_position'      => null,
