...
class WP_Travel_Admin_Menu {
	...
	function add_menus() {
		...
		add_submenu_page( 'edit.php?post_type=itineraries', __( 'Marketplace', 'wp-travel' ), __( 'Marketplace', 'wp-travel' ), 'manage_options', 'wp-travel-marketplace', 'wp_travel_marketplace_page' );
