...
class WP_Travel_Admin_Info_Pointers {
	...
	function enable_v4_pointer( $q ) {
		$pointer_content = '<p>Please go to WP Travel > Settings > General. Now enable siwtch to V4 option and save settings to enable WP Travel version 4.0.0 layout. <a href="https://wptravel.io/wp-travel-version-(4-0-0)-post-release-post" target="_blank">Learn More</a></p>';
