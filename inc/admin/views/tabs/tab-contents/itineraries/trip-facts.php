...
if ( ! function_exists( 'trip_callback_trip_facts' ) ) {
	function trip_callback_trip_facts() {
								 ...
								 <table class="form-table">
									 <tbody>
										 ...
										 <tr class="fact-holder faq-question-text">
											 ...
											 <td>
												 <select id="fact_type_{{data.random}}" required class="fact-type-selecter wp-travel-select2" data-hide-search="true" data-index="{{data.random}}" name="wp_travel_trip_facts[{{data.random}}][label]">
...
function wp_travel_fact_single( $fact, $index, $setting = array() ) {
	?>
	<select name="wp_travel_trip_facts[<?php echo $index; ?>][value]" id="" class="wp-travel-select2" data-hide-search="true">
		<?php
							...
							<tr class="fact-holder faq-question-text">
								<td>
									<div class="subject_input">
										<select class="fact-type-selecter wp-travel-select2" data-hide-search="true" data-index="<?php echo $index; ?>" name="<?php echo 'wp_travel_trip_facts[' . $index . '][label]'; ?>">
											<?php if ( ! isset( $type ) ) : ?>
												<option value=""><?php esc_html_e( 'Select a Label', 'wp-travel' ); ?></option>
											<?php endif; ?>  
