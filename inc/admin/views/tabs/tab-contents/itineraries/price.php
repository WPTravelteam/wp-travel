											...
											<div class="panel-body">
												<div class="panel-wrap">
													...
													<div class="repeat-row">
														...
														<div class="two-third">
															<div class="field-input">
																<input class="pricing-opt-min-pax" required type="number" name="wp_travel_pricing_options[<?php echo esc_attr( $pricing_id ); ?>][min_pax]" value="<?php echo esc_attr( $pricing_min_pax ); ?>">
															</div>
														</div>
													</div>
													<div class="repeat-row">
														...
														<div class="two-third">
															<div class="field-input">
																<input class="pricing-opt-max-pax" required type="number" name="wp_travel_pricing_options[<?php echo esc_attr( $pricing_id ); ?>][max_pax]" value="<?php echo esc_attr( $pricing_max_pax ); ?>">
															</div>
														</div>
													</div>
													<div class="repeat-row">
							...
							<div class="panel-body">
								<div class="panel-wrap">
									...
									<div class="repeat-row">
										...
										<div class="two-third">
											<input class="wp-travel-variation-pricing-min-pax" required="required" type="number" id="pricing_name_{{data.random}}_min_pax" name="wp_travel_pricing_options[{{data.random}}][min_pax]" value="">
										</div>
									</div>
									<div class="repeat-row">
										<label for="pricing_name_{{data.random}}_max_pax" class="one-third"><?php esc_html_e( 'Max Pax:', 'wp-travel' ); ?></label>
										<div class="two-third">
											<input class="wp-travel-variation-pricing-max-pax" required="required" type="number" id="pricing_name_{{data.random}}_max_pax" name="wp_travel_pricing_options[{{data.random}}][max_pax]" value="">
										</div>
									</div>
									<div class="repeat-row">
