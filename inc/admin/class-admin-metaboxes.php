...
class WP_Travel_Admin_Metaboxes {
	...
	public function save_meta_data( $post_id ) {
		...
		$trip_meta['wp_travel_pricing_option_type'] = isset( $_POST['wp_travel_pricing_option_type'] ) ? sanitize_text_field( wp_unslash( $_POST['wp_travel_pricing_option_type'] ) ) : 'multiple-price'; // default multiple price @since new-version-number.
