...
add_action( 'wp_travel_before_single_trip_main_contents', 'wp_travel_single_itinerary_maps' );
 ...
 * @param int $trip_id Trip ID.
 */
function wp_travel_single_trip_buttons( $trip_id ) {
 ...
 * @param int $trip_id Trip ID.
 */
function wp_travel_single_itinerary_meta_info( $trip_id ) {
	$strings               = wp_travel_get_strings();
 ...
 * @param int $trip_id Trip ID.
 */
function wp_travel_single_itinerary_maps( $trip_id ) {
	global $wp_travel_itinerary;
