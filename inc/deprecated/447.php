...
function wp_travel_update_payment_status($booking_id, $amount, $status, $args, $key = '_paypal_args', $payment_id = ''){
	wptravel_deprecated_function( "wp_travel_update_payment_status", "4.4.7", "wptravel_update_payment_status" );
	return wptravel_update_payment_status($booking_id, $amount, $status, $args, $key = '_paypal_args', $payment_id = '');
}
...
function wp_travel_initial_partial_payout_unformated($partial_payout, $force_format = ''){
...
function wp_travel_get_currency_symbol($currency_code = ''){
...
function wp_travel_get_enquiries_form($trips_dropdown = ''){
...
function wp_travel_get_trip_listing_option($trip_id = ''){
...
function wp_travel_trip_pricing_sort_by_date($pricings, $sort = 'asc'){
	...
	return wptravel_trip_pricing_sort_by_date($pricings, $sort = 'asc');
}

function wp_travel_get_trip_pricing_option($trip_id = ''){
...
function wp_travel_get_cart_item_price_with_extras($cart_id, $trip_id, $partial = ''){
...
function wp_travel_hide_price_per_field($trip_id = '', $price_key = ''){
...
function wp_travel_get_bank_deposit_account_table($show_description = '1'){
	wptravel_deprecated_function( "wp_travel_get_bank_deposit_account_table", "4.4.7", "wptravel_get_bank_deposit_account_table" );
	return wptravel_get_bank_deposit_account_table($show_description = '1');
}

function wp_travel_get_bank_deposit_account_details($display_all_row = ''){
...
function wp_travel_pax_alert_message($min = '', $max = ''){
...
function wp_travel_thankyou_page_url($trip_id = ''){
...
function wp_travel_view_booking_details_table($booking_id, $hide_payment_column = ''){
...
function wp_travel_get_trip_archive_filter_by($settings = ''){
...
function wp_travel_get_pricing_option_listing_type($settings = ''){
...
function wp_travel_sort_array_by_priority($array, $priority_key = 'priority'){
	...
	return wptravel_sort_array_by_priority($array, $priority_key = 'priority');
}
...
function wp_travel_get_pricing_category_by_key($key = ''){
...
function wp_travel_get_admin_trip_tabs($post_id, $custom_tab_enabled = '', $frontend_hide_content = ''){
...
function wp_travel_get_global_tabs($settings, $custom_tab_enabled = ''){
...
function wp_travel_get_default_trip_tabs($is_show_in_menu_query = '', $frontend_hide_content = ''){
...
function wp_travel_get_frontend_tabs($show_in_menu_query = '', $frontend_hide_content = ''){
...
function wp_travel_featured_itineraries($no_of_post_to_show = '3'){
	...
	return wptravel_featured_itineraries($no_of_post_to_show = '3');
}
...
function wp_travel_allowed_html($tags = array() ){
	...
	return wptravel_allowed_html($tags = array() );
}
...
function wp_travel_get_post_thumbnail_url($post_id, $size = 'wp_travel_thumbnail'){
	...
	return wptravel_get_post_thumbnail_url($post_id, $size = 'wp_travel_thumbnail');
}
...
function wp_travel_get_post_thumbnail($post_id, $size = 'wp_travel_thumbnail'){
	...
	return wptravel_get_post_thumbnail($post_id, $size = 'wp_travel_thumbnail');
}
...
function wp_travel_get_map_data($trip_id = ''){
...
function wp_travel_get_dropdown_list($args = array() ){
	...
	return wptravel_get_dropdown_list($args = array() );
}
...
function wp_travel_get_dropdown_currency_list($args = array() ){
	...
	return wptravel_get_dropdown_currency_list($args = array() );
}

function wp_travel_get_trip_code($post_id = ''){
...
function wp_travel_get_settings(){
	wptravel_deprecated_function( "wptravel_get_settings", "4.4.7", "wptravel_get_settings" );
...
function wp_travel_get_pricing_option_type($post_id = ''){
...
function wp_travel_get_formated_price_currency($price, $regular_price = '', $price_key = '', $post_id = ''){
...
function wp_travel_convert_price($price, $convert = '1'){
	wptravel_deprecated_function( "wp_travel_convert_price", "4.4.7", "wptravel_convert_price" );
	return wptravel_convert_price($price, $convert = '1');
}

function wp_travel_get_formated_price($price, $format = '1', $number_of_decimals = '2'){
	wptravel_deprecated_function( "wp_travel_get_formated_price", "4.4.7", "wptravel_get_formated_price" );
	return wptravel_get_formated_price($price, $format = '1', $number_of_decimals = '2');
}
...
function wp_travel_get_partial_trip_price($trip_id, $price_key = ''){
...
function wp_travel_get_price_per_text($trip_id, $price_key = '', $return_key = '', $category_id = ''){
...
function wp_travel_get_price_per_by_key($key = ''){
...
function wp_travel_make_stat_data($stat_datas, $show_empty = ''){
...
function wp_travel_format_date($date, $localize = '1', $base_date_format = ''){
	wptravel_deprecated_function( "wp_travel_format_date", "4.4.7", "wptravel_format_date" );
	return wptravel_format_date($date, $localize = '1', $base_date_format = '');
}
...
function wp_travel_get_total_booked_pax($trip_id, $including_cart = '1'){
	wptravel_deprecated_function( "wp_travel_get_total_booked_pax", "4.4.7", "wptravel_get_total_booked_pax" );
	return wptravel_get_total_booked_pax($trip_id, $including_cart = '1');
}
...
function wp_travel_deprecated_hook($hook, $version, $replacement = '', $message = ''){
...
function wp_travel_do_deprecated_action($tag, $args, $version, $replacement = '', $message = ''){
...
function wp_travel_deprecated_function($function, $version, $replacement = ''){
...
function wp_travel_pagination($range = '2', $pages = ''){
	...
	return wptravel_pagination($range = '2', $pages = '');
}
...
function wp_travel_get_rating_count($value = ''){
...
function wp_travel_get_average_rating($post_id = ''){
...
function wp_travel_get_review_count($post_id = ''){
...
function wp_travel_single_trip_rating($post_id, $hide_rating = ''){
...
function wp_travel_trip_price($trip_id, $hide_rating = ''){
...
function wp_travel_load_template($path, $args = array() ){
	...
	return wptravel_load_template($path, $args = array() );
}
...
function wp_travel_get_template_html($template_name, $args = array() ){
	...
	return wptravel_get_template_html($template_name, $args = array() );
}
...
function wp_travel_get_template($template_name, $args = array() ){
	...
	return wptravel_get_template($template_name, $args = array() );
}
...
// function wp_travel_is_endpoint_url($endpoint = ''){
// 	wptravel_deprecated_function( "wp_travel_is_endpoint_url", "4.4.7", "wptravel_is_endpoint_url" );
// 	return wptravel_is_endpoint_url($endpoint = '');
// }
...
function wp_travel_get_paypal_redirect_url($ssl_check = ''){
...
function wp_travel_bank_deposite_content($booking_id = '', $details = array() ){
	wptravel_deprecated_function( "wp_travel_bank_deposite_content", "4.4.7", "wptravel_bank_deposite_content" );
	return wptravel_bank_deposite_content($booking_id = '', $details = array() );
}

function wp_travel_bank_deposite_button($booking_id = '', $details = array() ){
	wptravel_deprecated_function( "wp_travel_bank_deposite_button", "4.4.7", "wptravel_bank_deposite_button" );
	return wptravel_bank_deposite_button($booking_id = '', $details = array() );
}
...
// 	wptravel_deprecated_function( "wp_travel_register_wp_travel_search_filter_widgets", "4.4.7", "wptravel_register_wptravel_search_filter_widgets" );
// 	return wptravel_register_wptravel_search_filter_widgets();
// }

// function wp_travel_register_wp_travel_enquiry_form_widgets(){
// 	wptravel_deprecated_function( "wp_travel_register_wp_travel_enquiry_form_widgets", "4.4.7", "wptravel_register_wptravel_enquiry_form_widgets" );
// 	return wptravel_register_wptravel_enquiry_form_widgets();
// }
