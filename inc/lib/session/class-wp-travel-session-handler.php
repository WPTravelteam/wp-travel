 ...
 */
class WP_Travel_Session_Handler extends WT_Session {
	...
	public function __construct() {
		$this->_cookie = apply_filters( 'wp_travel_cookie', 'wp_travel_session_' . COOKIEHASH );
		$this->_table  = $GLOBALS['wpdb']->prefix . 'wt_sessions';
	}
