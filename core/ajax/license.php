...
class WP_Travel_Ajax_License {
	...
	public static function init() {
		...
		add_action( 'wp_ajax_wp_travel_deactivate_license', array( __CLASS__, 'deactivate_license' ) );
		add_action( 'wp_ajax_nopriv_wp_travel_deactivate_license', array( __CLASS__, 'deactivate_license' ) );
	...
	public static function deactivate_license() {
		...
		$postData = json_decode( file_get_contents( 'php://input' ), true ); // Added 2nd Parameter to resolve issue with objects.
		$response = WP_Travel_Helpers_License::deactivate_license( $postData );
