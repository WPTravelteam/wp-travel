...
class WP_Travel_Helpers_Media {
	public static function get_attachment_meta_data( $id = false ) {
        ...
        if ( ! empty( $attachment_meta_data ) ) {
            ...
            $attachment['id']  = $id;
            $attachment['width']  = $attachment_meta_data['width'];
            $attachment['height'] = $attachment_meta_data['height'];
            $attachment['url']    = $full_attachment;
            $attachment['file']   = $attachment_meta_data['file'];
            $attachment['sizes']  = $attachment_meta_data['sizes'];
        ...
        return WP_Travel_Helpers_Response_Codes::get_success_response( 'WP_TRAVEL_ATTACHMENT_DATA', array(
