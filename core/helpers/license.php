...
class WP_Travel_Helpers_License {
	...
	public static function init() {
		...
		// Licesnse data for 
		add_filter( 'wp_travel_settings_options', 'WP_Travel_Helpers_License::settings_data', 10, 2 );
	}

	// License data for WP Settings block.
	public static function settings_data( $options, $settings ) {
		...
		$options['premium_addons'] = $premium_addons;
		return $options;
	}
