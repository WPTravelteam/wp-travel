...
Layout Fixes:
* Single Trip Page, review form layout changed.
* Single Trip Page trip tabs layout fixed in responsive and mobile view.
* Single Trip page sidebar width fixed in travel master theme.
* Trip Facts Block layout fixed in the front end.
