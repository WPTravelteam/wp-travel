		...
		if ( get_current_screen()->base == 'dashboard_page_wp-travel-setup-page' ) {
			$theme_lists = array(
				...
				array(
					...
					'screenshot' => 'http://wpdemo.wensolutions.com/travelin/wp-content/uploads/sites/17/2023/11/screenshot-1-min-1.png',
				),
				array(
					'name'		 =>	'Travelvania',
					'slug'       => 'travelvania',
					'theme_page' => 'https://wensolutions.com/themes/travelvania/',
					'screenshot' => 'http://wpdemo.wensolutions.com/travelvania/wp-content/uploads/sites/16/2023/11/Travelvania-1-1024x736-min.png',
				),
				array(
					'name'		 => 'WP Travel Fse', 
					'slug'       => 'wp-travel-fse',
				...
				array(
					...
					'screenshot' => 'http://wpdemo.wensolutions.com/wp-content/uploads/2023/08/Travel-Joy-pro.png',
				),
				array(
					'name'       => 'Travel One',
					'slug'       => 'travel-one',
				...
				array(
					...
					'screenshot' => 'https://www.eaglevisionit.com/wp-content/uploads/2023/09/screenshot-41-1024x768.png',
				),
				array(
					'name'       => 'Travel Store',
					'slug'       => 'travel-store',
					'theme_page' => 'https://www.eaglevisionit.com/downloads/travel-store/',
					'screenshot' => 'https://www.eaglevisionit.com/wp-content/uploads/2023/08/screenshot-26-1024x768.png',
				),
				array(
					'name'       => 'Travel FSE',
					'slug'       => 'travel-fse',
					'theme_page' => 'https://www.eaglevisionit.com/downloads/travel-fse/',
					'screenshot' => 'https://www.eaglevisionit.com/wp-content/uploads/2023/06/screenshot-1-1-1024x768.png',
				),
				array(
					'name'       => 'Travel Ride',
					'slug'       => 'travel-ride',
					'theme_page' => 'https://www.eaglevisionit.com/downloads/travel-ride/',
					'screenshot' => 'https://www.eaglevisionit.com/wp-content/uploads/2023/09/travel-ride-1024x768.png',
				),
				array(
					'name'       => 'Travel Escape',
					'slug'       => 'travel-escape',
