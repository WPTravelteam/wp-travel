...
=======
    // console.log(allData)
>>>>>>> c1bd037455553939c5557efca61ec478736f6afe
...
<<<<<<< HEAD
            { 'yes' == partial_payment ? minimum_partial_payout.map( (minPayout, index ) => {
                var label = minimum_partial_payout.length > 1 ? __( 'Partial Payout ' + (x++) + '(%)',  '' ) : __( 'Minimum Payout (%)', 'wp-travel' );
                return <PanelRow>
                    <label>{ label }</label>
