				...
				categories.map((c, i) => {
					...
					return <li key={i}>
						...
						<div className="text-right">
							<span className="item-price">{c.is_sale && <del dangerouslySetInnerHTML={{ __html: wpTravelFormat(getCategoryPrice( c.regular_price )) }}></del>} <span dangerouslySetInnerHTML={{ __html: wpTravelFormat(getCategoryPrice(c.id, true)) }}></span>/{price_per_label}</span>
