	...
	<div class="content entry-content">
		<div class="wp-travel trip-headline-wrapper">
	         <div class="wp-travel-feature-slide-content featured-side-image left-plot">
	            <div class="banner-image-wrapper" style="background-image: url(<?php echo wp_travel_get_post_thumbnail_url( get_the_ID() ) ?>)">
	         	  <?php //the_post_thumbnail(); ?>

	         	  <?php 
	         	  echo wp_travel_get_post_thumbnail( get_the_ID() ); 
	         	  ?>
	         	</div> 
	         	<?php if ( $enable_sale ) : ?>     	
